    ...
    return (
      <div className="custom-container py-5 my-5">
        <div className="d-flex flex-column align-items-center mb-5 pb-4">
          ...
          <p
            className="text-center font-size-display1 mb-3 font-weight-bold"
            style={{ maxWidth: '32rem', color: '#9ddfd3' }}
          >
            Limited quatities on products and restocks.
          </p>
          <Link href="/collection">
            <a className="d-flex py-3 align-items-center font-color-black borderbottom border-color-black">
              <p className="mr-3" style={{ color: '#31326f' }}>See more!</p>
